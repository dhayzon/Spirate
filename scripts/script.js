...
{
	popup_class = 'modal-dialog popup_window ' + (this.opt.custom_class ? this.opt.custom_class : 'description');
	...
	$('body').append('<div id="' + this.popup_id + '" class="popup_container modal "><div class="' + popup_class + '"><div class="modal-content"><div class="h2 popup_heading modal-header p-5"><div>' + icon + this.opt.heading + '</div><a href="javascript:void(0);" class="main_icons hide_popup"></a></div><div class="popup_content modal-body p-5 pt-0">' + this.opt.content + '</div></div></div></div><div class="modal-backdrop fade show"></div>');
...
{
	$('.modal-backdrop, #' + this.popup_id).fadeOut(300, function(){ $(this).remove(); });
...
function expandPages(spanNode, baseLink, firstPage, lastPage, perPage)
{
	...
	// Add the new page links. fix dhayzon
	$(spanNode).parent().before(replacement);
