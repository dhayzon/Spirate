...
function template_unread()
{
	...
	{
		echo '
			<div class="pagesection d-flex"> 
				<div class="pagelinks me-auto"> 
					', $context['page_index'], '
				</div>
		...
		echo '
			<div id="unread">
				<div id="topic_header" class="title_bar d-flex">
					<div class="board_icon d-inline-block"></div>
		...
		foreach ($context['topics'] as $topic)
		{
			echo '
					<div class="', $topic['css_class'], '">
						<div class="board_icon d-inline-block">
...
function template_replies()
{
	...
	if (!empty($context['topics']))
	{
		...
		foreach ($context['topics'] as $topic)
		{
			...
			if ($context['showChecC:\xampp\htdocs\plantilla\Themes\default\Display.template.php, C:\xampp\htdocs\plantilla\Themes\default\Errors.template.php, C:\xampp\htdocs\plantilla\Themes\default\ManageBans.template.php, C:\xampp\htdocs\plantilla\Themes\default\ModerationCenter.template.php, C:\xampp\htdocs\plantilla\Themes\default\Profile.template.php, C:\xampp\htdocs\plantilla\Themes\default\Who.template.phpkboxes'])
				echo '
						<div class="moderation">
							<input type="checkbox" name="topics[]" value="', $topic['id'], '">
						</div>';
