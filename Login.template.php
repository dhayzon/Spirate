 ...
 */
/**
 * This is just the basic "ajax login" form.
 */
function template_ajax_login()
{
	...
	echo '<div class="roundframe">
			...
			<input   class="form-control rounded-4" placeholder="', $txt['username'], '" type="text" id="ajax_loginuser" name="user" size="20" value="', $context['default_username'], '" required>
			<label for="ajax_loginuser">', $txt['username'], '</label>
			</div>
			<div class="form-floating mb-3">
			<input  type="password" class="form-control rounded-4"   placeholder="', $txt['password'], '" id="ajax_loginpass" name="passwrd" value="', $context['default_password'], '" size="20" required>
			<label for="ajax_loginpass">', $txt['password'], '</label>
			</div>
			<div class="checkbox mb-3">
				<label>
				<input type="checkbox" name="cookieneverexp" id="cookielength" value="-1"> ', $txt['time_logged_in'], '
				</label>
		    </div>
			 
			<button class="w-100 mb-2 btn btn-lg rounded-4 btn-primary" type="submit">', $txt['login'], '</button>
			<small class="text-muted">', sprintf($txt['login_below_or_register'], $scripturl . '?action=signup', $context['forum_name_html_safe']), '.</small>
			<hr class="my-4"> ';
...
<div class="modal-dialog" role="document">
  <div class="modal-content rounded-5 shadow">
	<div class="modal-header p-5 pb-4 border-bottom-0"> 
	  <h2 class="fw-bold mb-0"> ', $txt['login'], '</h2>
	</div>

	<div class="modal-body p-5 pt-0">
	  <form action="', $context['login_url'], '" method="post" accept-charset="', $context['character_set'], '" name="frmLogin" id="frmLogin">
		<div class="form-floating mb-3">
		  <input  class="form-control rounded-4" id="floatingInput" placeholder="name@example.com" type="text" name="user" size="20">
		  <label for="floatingInput">', $txt['username'], '</label>
		</div>
		<div class="form-floating mb-3">
		  <input class="form-control rounded-4" id="floatingPassword" placeholder="', $txt['password'], '" type="password" name="passwrd" size="20">
		  <label for="floatingPassword">', $txt['password'], '</label>
		</div>
		<div class="checkbox mb-3">
		<label>
			<input type="checkbox"  name="cookieneverexp" id="cookielength" value="-1"> ', $txt['time_logged_in'], '
